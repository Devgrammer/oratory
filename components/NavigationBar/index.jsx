...
const NavigationBar = () => {
  ...
  return (
    <div className="navigation-bar-main-container h-[67px] box-border border-b flex justify-start items-center pl-[100px]">
      <div className="navigation-bar-sub-container min-w-[590px] flex justify-between items-center">
        <div
          id="job-preview"
          className={`navigation-bar-menu-item  leading-[27px] text-[20px]   cursor-pointer  ${
